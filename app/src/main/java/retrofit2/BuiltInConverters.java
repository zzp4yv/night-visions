...
final class BuiltInConverters extends Converter.Factory {
    ...
    static final class UnitResponseBodyConverter implements Converter<ResponseBody, C10742u> {
        ...
        @Override // retrofit2.Converter
        public C10742u convert(ResponseBody responseBody) {
            responseBody.close();
    ...
    public Converter<ResponseBody, ?> responseBodyConverter(Type type, Annotation[] annotationArr, Retrofit retrofit) {
        ...
        if (!this.checkForKotlinUnit || type != C10742u.class) {
            return null;
        }
        try {
