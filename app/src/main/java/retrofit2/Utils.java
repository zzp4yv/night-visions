...
final class Utils {
    ...
    static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            for (Type type3 : typeArr) {
                C11171c.m39905a(type3, "typeArgument == null");
    ...
    static ResponseBody buffer(ResponseBody responseBody) throws IOException {
        ...
        responseBody.source().mo32026Y0(c9670f);
        return ResponseBody.create(responseBody.contentType(), responseBody.contentLength(), c9670f);
    }
