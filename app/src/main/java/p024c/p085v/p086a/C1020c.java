...
public class C1020c extends ViewGroup implements InterfaceC0304n, InterfaceC0300j {
    ...
    class f extends Animation {
        ...
        public void applyTransformation(float f2, Transformation transformation) {
            C1020c c1020c = C1020c.this;
            int abs = !c1020c.mUsingCustomStart ? c1020c.mSpinnerOffsetEnd - Math.abs(c1020c.mOriginalOffsetTop) : c1020c.mSpinnerOffsetEnd;
            C1020c c1020c2 = C1020c.this;
            C1020c.this.setTargetOffsetTopAndBottom((c1020c2.mFrom + ((int) ((abs - r1) * f2))) - c1020c2.mCircleView.getTop());
    ...
    private void moveSpinner(float f2) {
        ...
        this.mProgress.m6490j(0.0f, Math.min(MAX_PROGRESS_ANGLE, max * MAX_PROGRESS_ANGLE));
        this.mProgress.m6487e(Math.min(1.0f, max));
        this.mProgress.m6489g((((max * 0.4f) - 0.25f) + (f4 * DECELERATE_INTERPOLATION_FACTOR)) * DRAG_RATE);
