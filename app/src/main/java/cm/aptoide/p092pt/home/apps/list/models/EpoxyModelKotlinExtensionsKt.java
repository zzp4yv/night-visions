...
public final class EpoxyModelKotlinExtensionsKt {
    public static final void downloadCard(AbstractC5128n abstractC5128n, Function1<? super DownloadCardModelBuilder, C10742u> function1) {
        ...
        downloadCardModel_.addTo(abstractC5128n);
    }

    public static final void installedCard(AbstractC5128n abstractC5128n, Function1<? super InstalledCardModelBuilder, C10742u> function1) {
        C9768m.m32346f(abstractC5128n, "<this>");
        C9768m.m32346f(function1, "modelInitializer");
        InstalledCardModel_ installedCardModel_ = new InstalledCardModel_();
        function1.invoke(installedCardModel_);
        installedCardModel_.addTo(abstractC5128n);
    }

    public static final void title(AbstractC5128n abstractC5128n, Function1<? super TitleModelBuilder, C10742u> function1) {
        C9768m.m32346f(abstractC5128n, "<this>");
        C9768m.m32346f(function1, "modelInitializer");
        TitleModel_ titleModel_ = new TitleModel_();
        function1.invoke(titleModel_);
        titleModel_.addTo(abstractC5128n);
    }

    public static final void updateCard(AbstractC5128n abstractC5128n, Function1<? super UpdateCardModelBuilder, C10742u> function1) {
        C9768m.m32346f(abstractC5128n, "<this>");
        C9768m.m32346f(function1, "modelInitializer");
        UpdateCardModel_ updateCardModel_ = new UpdateCardModel_();
        function1.invoke(updateCardModel_);
        updateCardModel_.addTo(abstractC5128n);
    }
}
