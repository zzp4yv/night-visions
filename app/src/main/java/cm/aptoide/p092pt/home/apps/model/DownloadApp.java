...
public final /* data */ class DownloadApp implements StateApp {
    ...
    public boolean equals(Object other) {
        ...
        return C9768m.m32341a(this.name, downloadApp.name) && C9768m.m32341a(getMd5(), downloadApp.getMd5()) && C9768m.m32341a(this.icon, downloadApp.icon) && C9768m.m32341a(getPackageName(), downloadApp.getPackageName()) && getProgress() == downloadApp.getProgress() && C9768m.m32341a(this.version, downloadApp.version) && getVersionCode() == downloadApp.getVersionCode() && getStatus() == downloadApp.getStatus() && this.appId == downloadApp.appId;
    }
    ...
    public int hashCode() {
        return (((((((((((((((this.name.hashCode() * 31) + getMd5().hashCode()) * 31) + this.icon.hashCode()) * 31) + getPackageName().hashCode()) * 31) + getProgress()) * 31) + this.version.hashCode()) * 31) + getVersionCode()) * 31) + (getStatus() == null ? 0 : getStatus().hashCode())) * 31) + C1141a.m6829a(this.appId);
    }
    ...
    public /* synthetic */ DownloadApp(String str, String str2, String str3, String str4, int i2, String str5, int i3, StateApp.Status status, long j2, int i4, C9756g c9756g) {
