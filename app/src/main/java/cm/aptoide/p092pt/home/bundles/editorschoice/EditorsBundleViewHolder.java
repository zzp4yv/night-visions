...
public class EditorsBundleViewHolder extends AppBundleViewHolder {
    ...
    public EditorsBundleViewHolder(View view, C11370b<HomeEvent> c11370b, DecimalFormat decimalFormat, String str) {
        super(view);
        this.marketName = str;
        ...
        RecyclerView recyclerView = (RecyclerView) view.findViewById(C1138R.id.featured_graphic_list);
        this.graphicsList = recyclerView;
        EditorsAppsAdapter editorsAppsAdapter = new EditorsAppsAdapter(new ArrayList(), decimalFormat, c11370b);
        ...
        this.skeleton = SkeletonUtils.applySkeleton(recyclerView, C1138R.layout.feature_graphic_home_item_skeleton, Type.APPS_GROUP.getPerLineCount(view.getContext().getResources(), (WindowManager) view.getContext().getSystemService("window")) * 3);
    }
    ...
    public void setBundle(final HomeBundle homeBundle, int i2) {
        ...
        this.moreButton.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.home.bundles.editorschoice.a
            ...
            public final void onClick(View view) {
                EditorsBundleViewHolder.this.m8084a(homeBundle, view);
            }
        });
    }
}
