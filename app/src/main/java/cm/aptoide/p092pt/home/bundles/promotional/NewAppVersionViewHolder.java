...
public final class NewAppVersionViewHolder extends AppBundleViewHolder {
    ...
    public NewAppVersionViewHolder(View view, C11370b<HomeEvent> c11370b) {
        super(view);
    ...
    public static final void m40851setBundle$lambda2$lambda0(NewAppVersionViewHolder newAppVersionViewHolder, HomeBundle homeBundle, View view) {
        C9768m.m32346f(newAppVersionViewHolder, "this$0");
    ...
    private final void toggleSkeleton(boolean showSkeleton) {
        if (showSkeleton) {
            ...
            ((SkeletonView) this.itemView.findViewById(C1138R.id.version_text_skeleton)).setVisibility(0);
            ((SkeletonView) this.itemView.findViewById(C1138R.id.version_name_skeleton)).setVisibility(0);
            ((TextView) this.itemView.findViewById(C1138R.id.version_name)).setVisibility(4);
        ...
        ((SkeletonView) this.itemView.findViewById(C1138R.id.version_text_skeleton)).setVisibility(4);
        ((SkeletonView) this.itemView.findViewById(C1138R.id.version_name_skeleton)).setVisibility(4);
        ((TextView) this.itemView.findViewById(C1138R.id.version_name)).setVisibility(0);
    ...
    public void setBundle(final HomeBundle homeBundle, int position) {
        ...
        if ((z ? (VersionPromotionalBundle) homeBundle : null) != null) {
            ...
            ImageLoader.with(this.itemView.getContext()).loadWithRoundCorners(versionPromotionalBundle.getApp().getIcon(), 32, (ImageView) this.itemView.findViewById(C1138R.id.app_icon), C1138R.attr.placeholder_square);
            ((TextView) this.itemView.findViewById(C1138R.id.card_title_label_text)).setText(versionPromotionalBundle.getTitle());
            ImageLoader.with(this.itemView.getContext()).load(versionPromotionalBundle.getApp().getFeatureGraphic(), (ImageView) this.itemView.findViewById(C1138R.id.app_background_image));
            ((TextView) this.itemView.findViewById(C1138R.id.app_name)).setText(versionPromotionalBundle.getApp().getName());
            ((TextView) this.itemView.findViewById(C1138R.id.version_name)).setText(versionPromotionalBundle.getVersionName());
            ((Button) this.itemView.findViewById(C1138R.id.action_button)).setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.home.bundles.promotional.e
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    NewAppVersionViewHolder.m40851setBundle$lambda2$lambda0(NewAppVersionViewHolder.this, homeBundle, view);
                }
            });
            this.itemView.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.home.bundles.promotional.d
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    NewAppVersionViewHolder.m40852setBundle$lambda2$lambda1(NewAppVersionViewHolder.this, homeBundle, view);
                }
            });
