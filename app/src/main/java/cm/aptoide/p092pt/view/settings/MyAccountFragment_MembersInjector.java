...
public final class MyAccountFragment_MembersInjector implements InterfaceC9020a<MyAccountFragment> {
    ...
    public static InterfaceC9020a<MyAccountFragment> create(Provider<MyAccountNavigator> provider, Provider<AccountAnalytics> provider2, Provider<MyAccountManager> provider3, Provider<String> provider4, Provider<ThemeManager> provider5, Provider<SocialMediaAnalytics> provider6) {
