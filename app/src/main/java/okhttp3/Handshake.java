...
public final class Handshake {
    ...
    public static final class Companion {
        ...
        private final List<Certificate> toImmutableList(Certificate[] certificateArr) {
            return certificateArr != null ? Util.immutableListOf((Certificate[]) Arrays.copyOf(certificateArr, certificateArr.length)) : C10784u.m38888j();
        }

        /* renamed from: -deprecated_get, reason: not valid java name */
        public final Handshake m41100deprecated_get(SSLSession sslSession) throws IOException {
            C9768m.m32346f(sslSession, "sslSession");
            return get(sslSession);
        }

        public final Handshake get(SSLSession sSLSession) throws IOException {
            List<Certificate> m38888j;
            C9768m.m32346f(sSLSession, "$this$handshake");
            ...
            if (C9768m.m32341a("NONE", protocol)) {
                throw new IOException("tlsVersion == NONE");
            }
            TlsVersion forJavaName2 = TlsVersion.INSTANCE.forJavaName(protocol);
            try {
                m38888j = toImmutableList(sSLSession.getPeerCertificates());
            } catch (SSLPeerUnverifiedException unused) {
                m38888j = C10784u.m38888j();
            }
            return new Handshake(forJavaName2, forJavaName, toImmutableList(sSLSession.getLocalCertificates()), new Handshake$Companion$handshake$1(m38888j));
        }
        ...
        public final Handshake get(TlsVersion tlsVersion, CipherSuite cipherSuite, List<? extends Certificate> peerCertificates, List<? extends Certificate> localCertificates) {
            C9768m.m32346f(tlsVersion, "tlsVersion");
            C9768m.m32346f(cipherSuite, "cipherSuite");
            C9768m.m32346f(peerCertificates, "peerCertificates");
            C9768m.m32346f(localCertificates, "localCertificates");
    ...
    public Handshake(TlsVersion tlsVersion, CipherSuite cipherSuite, List<? extends Certificate> list, Function0<? extends List<? extends Certificate>> function0) {
        ...
        C9768m.m32346f(tlsVersion, "tlsVersion");
        C9768m.m32346f(cipherSuite, "cipherSuite");
        C9768m.m32346f(list, "localCertificates");
        C9768m.m32346f(function0, "peerCertificatesFn");
        this.tlsVersion = tlsVersion;
        this.cipherSuite = cipherSuite;
        this.localCertificates = list;
        m37594b = C10517i.m37594b(new Handshake$peerCertificates$2(function0));
        this.peerCertificates = m37594b;
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof Handshake) {
            ...
            if (handshake.tlsVersion == this.tlsVersion && C9768m.m32341a(handshake.cipherSuite, this.cipherSuite) && C9768m.m32341a(handshake.peerCertificates(), peerCertificates()) && C9768m.m32341a(handshake.localCertificates, this.localCertificates)) {
                return true;
            }
        }
        return false;
    ...
    public final Principal localPrincipal() {
        Object m38832W = C10780s.m38832W(this.localCertificates);
        if (!(m38832W instanceof X509Certificate)) {
            m38832W = null;
        }
        X509Certificate x509Certificate = (X509Certificate) m38832W;
    ...
    public final Principal peerPrincipal() {
        Object m38832W = C10780s.m38832W(peerCertificates());
        if (!(m38832W instanceof X509Certificate)) {
            m38832W = null;
        }
        X509Certificate x509Certificate = (X509Certificate) m38832W;
