...
public final class HostnamesKt {
    private static final boolean containsInvalidHostnameAsciiCodes(String str) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (C9768m.m32348h(charAt, 31) <= 0 || C9768m.m32348h(charAt, 127) >= 0 || C10514v.m37556V(" #%/:?@[\\]", charAt, 0, false, 6, null) != -1) {
                return true;
            }
        }
        return false;
    ...
    private static final boolean decodeIpv4Suffix(String str, int i2, int i3, byte[] bArr, int i4) {
        ...
        while (i2 < i3) {
            ...
            while (i6 < i3) {
                ...
                if (C9768m.m32348h(charAt, 48) < 0 || C9768m.m32348h(charAt, 57) > 0) {
                    break;
                }
    ...
    */
    ...
    private static final String inet6AddressToAscii(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            if (i2 == i3) {
                ...
                c9670f.mo32001C0((Util.and(bArr[i2], 255) << 8) | Util.and(bArr[i2 + 1], 255));
                i2 += 2;
            }
        }
    ...
    public static final String toCanonicalHost(String str) {
        boolean m37538J;
        C9768m.m32346f(str, "$this$toCanonicalHost");
        m37538J = C10514v.m37538J(str, ":", false, 2, null);
        if (!m37538J) {
            try {
                String ascii = IDN.toASCII(str);
                C9768m.m32345e(ascii, "IDN.toASCII(host)");
        ...
        InetAddress decodeIpv6 = (C10513u.m37511E(str, "[", false, 2, null) && C10513u.m37514p(str, "]", false, 2, null)) ? decodeIpv6(str, 1, str.length() - 1) : decodeIpv6(str, 0, str.length());
        if (decodeIpv6 == null) {
            return null;
        }
        byte[] address = decodeIpv6.getAddress();
        if (address.length == 16) {
            C9768m.m32345e(address, "address");
