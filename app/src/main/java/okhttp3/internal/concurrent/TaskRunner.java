...
public final class TaskRunner {
    ...
    public static final class RealBackend implements Backend {
        ...
        public RealBackend(ThreadFactory threadFactory) {
            C9768m.m32346f(threadFactory, "threadFactory");
    ...
    static {
        ...
        C9768m.m32345e(logger2, "Logger.getLogger(TaskRunner::class.java.name)");
        logger = logger2;
    }

    public TaskRunner(Backend backend) {
        C9768m.m32346f(backend, "backend");
                ...
                while (true) {
                    ...
                    try {
                        try {
                            ...
                            if (isLoggable) {
                                TaskLoggerKt.log(awaitTaskToRun, queue, "finished run in " + TaskLoggerKt.formatDuration(queue.getTaskRunner().getBackend().nanoTime() - j2));
                            }
                        } finally {
                        }
                    } catch (Throwable th) {
                        if (isLoggable) {
                            TaskLoggerKt.log(awaitTaskToRun, queue, "failed a run in " + TaskLoggerKt.formatDuration(queue.getTaskRunner().getBackend().nanoTime() - j2));
                        }
                        throw th;
                    }
                }
    ...
    public final void runTask(Task task) {
        ...
        C9768m.m32345e(currentThread2, "currentThread");
    ...
    public final List<TaskQueue> activeQueues() {
        List<TaskQueue> m38609o0;
        synchronized (this) {
            m38609o0 = C10749c0.m38609o0(this.busyQueues, this.readyQueues);
        }
        return m38609o0;
    }
    ...
    public final void kickCoordinator$okhttp(TaskQueue taskQueue) {
        C9768m.m32346f(taskQueue, "taskQueue");
        if (Util.assertionsEnabled && !Thread.holdsLock(this)) {
            StringBuilder sb = new StringBuilder();
            sb.append("Thread ");
            Thread currentThread = Thread.currentThread();
