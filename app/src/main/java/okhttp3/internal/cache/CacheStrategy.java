        ...
        public Factory(long j2, Request request, Response response) {
            ...
            if (response != null) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    ...
                    if (C10513u.m37515q(name, "Date", true)) {
                        this.servedDate = DatesKt.toHttpDateOrNull(value);
                        this.servedDateString = value;
                    } else if (C10513u.m37515q(name, "Expires", true)) {
                        this.expires = DatesKt.toHttpDateOrNull(value);
                    } else if (C10513u.m37515q(name, "Last-Modified", true)) {
                        this.lastModified = DatesKt.toHttpDateOrNull(value);
                        this.lastModifiedString = value;
                    } else if (C10513u.m37515q(name, "ETag", true)) {
                        this.etag = value;
                    } else if (C10513u.m37515q(name, "Age", true)) {
