...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    private final Request buildRedirectRequest(Response userResponse, String method) {
        ...
        if (!C9768m.m32341a(resolve.scheme(), userResponse.request().url().scheme()) && !this.client.followSslRedirects()) {
            return null;
        }
    ...
    private final int retryAfter(Response userResponse, int defaultDelay) {
        ...
        if (!new Regex("\\d+").m37438b(header$default)) {
            return Integer.MAX_VALUE;
        }
        Integer valueOf = Integer.valueOf(header$default);
        C9768m.m32345e(valueOf, "Integer.valueOf(header)");
            ...
            try {
                ...
                try {
                    ...
                    if (!recover(e2, call, request, !(e2 instanceof ConnectionShutdownException))) {
                        throw Util.withSuppressed(e2, m38888j);
                    }
                    m38888j = C10749c0.m38610p0(m38888j, e2);
                    call.exitNetworkInterceptorExchange$okhttp(true);
                    z = false;
                } catch (RouteException e3) {
                    if (!recover(e3.getLastConnectException(), call, request, false)) {
                        throw Util.withSuppressed(e3.getFirstConnectException(), m38888j);
                    }
                    m38888j = C10749c0.m38610p0(m38888j, e3.getFirstConnectException());
                    call.exitNetworkInterceptorExchange$okhttp(true);
                    z = false;
                }
