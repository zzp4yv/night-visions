...
public final class AndroidPlatform extends Platform {
    ...
    public static final /* data */ class CustomTrustRootIndex implements TrustRootIndex {
        ...
        public CustomTrustRootIndex(X509TrustManager x509TrustManager, Method method) {
            C9768m.m32346f(x509TrustManager, "trustManager");
            C9768m.m32346f(method, "findByIssuerAndSignatureMethod");
        ...
        public final CustomTrustRootIndex copy(X509TrustManager trustManager, Method findByIssuerAndSignatureMethod) {
            ...
            C9768m.m32346f(findByIssuerAndSignatureMethod, "findByIssuerAndSignatureMethod");
        ...
        public boolean equals(Object other) {
            ...
            return C9768m.m32341a(this.trustManager, customTrustRootIndex.trustManager) && C9768m.m32341a(this.findByIssuerAndSignatureMethod, customTrustRootIndex.findByIssuerAndSignatureMethod);
        }

        @Override // okhttp3.internal.tls.TrustRootIndex
        public X509Certificate findByIssuerAndSignature(X509Certificate cert) {
            C9768m.m32346f(cert, "cert");
            try {
    ...
    public AndroidPlatform() {
        List m38893o;
        m38893o = C10784u.m38893o(StandardAndroidSocketAdapter.Companion.buildIfSupported$default(StandardAndroidSocketAdapter.INSTANCE, null, 1, null), new DeferredSocketAdapter(AndroidSocketAdapter.INSTANCE.getPlayProviderFactory()), new DeferredSocketAdapter(ConscryptSocketAdapter.INSTANCE.getFactory()), new DeferredSocketAdapter(BouncyCastleSocketAdapter.INSTANCE.getFactory()));
        ArrayList arrayList = new ArrayList();
        for (Object obj : m38893o) {
    ...
    public TrustRootIndex buildTrustRootIndex(X509TrustManager trustManager) {
        ...
        try {
            ...
            C9768m.m32345e(declaredMethod, "method");
    ...
    public boolean isCleartextTrafficPermitted(String hostname) {
        ...
        C9768m.m32345e(networkSecurityPolicy, "NetworkSecurityPolicy.getInstance()");
