...
public final class ConscryptPlatform extends Platform {
    ...
    public static final class Companion {
        ...
        public final ConscryptPlatform buildIfSupported() {
            C9756g c9756g = null;
            if (isSupported()) {
                return new ConscryptPlatform(c9756g);
            }
            return null;
        }
    ...
    private ConscryptPlatform() {
        ...
        C9768m.m32345e(newProvider, "Conscrypt.newProvider()");
    ...
    public SSLContext newSSLContext() {
        ...
        C9768m.m32345e(sSLContext, "SSLContext.getInstance(\"TLS\", provider)");
        return sSLContext;
    }
    ...
    public X509TrustManager platformTrustManager() {
        ...
        C9768m.m32345e(trustManagerFactory, "TrustManagerFactory.getI…(null as KeyStore?)\n    }");
    ...
    public /* synthetic */ ConscryptPlatform(C9756g c9756g) {
        this();
    }
}
