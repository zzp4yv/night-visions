...
public final class RouteSelector {
    ...
    public static final class Companion {
        ...
        public final String getSocketHost(InetSocketAddress inetSocketAddress) {
            C9768m.m32346f(inetSocketAddress, "$this$socketHost");
            InetAddress address = inetSocketAddress.getAddress();
            if (address != null) {
                String hostAddress = address.getHostAddress();
                C9768m.m32345e(hostAddress, "address.hostAddress");
                return hostAddress;
            }
            String hostName = inetSocketAddress.getHostName();
            C9768m.m32345e(hostName, "hostName");
            return hostName;
        }
    ...
    public RouteSelector(Address address, RouteDatabase routeDatabase, Call call, EventListener eventListener) {
        ...
        C9768m.m32346f(routeDatabase, "routeDatabase");
        ...
        this.proxies = C10784u.m38888j();
        this.inetSocketAddresses = C10784u.m38888j();
    ...
    public final Selection next() throws IOException {
        ...
        if (arrayList.isEmpty()) {
            C10794z.m38933z(arrayList, this.postponedRoutes);
