...
public final class ExchangeFinder {
    ...
    */
    ...
    public final ExchangeCodec find(OkHttpClient client, RealInterceptorChain chain) {
        ...
        try {
            return findHealthyConnection(chain.getConnectTimeoutMillis$okhttp(), chain.getReadTimeoutMillis(), chain.getWriteTimeoutMillis(), client.pingIntervalMillis(), client.retryOnConnectionFailure(), !C9768m.m32341a(chain.getRequest().method(), "GET")).newCodec$okhttp(client, chain);
    ...
    public final boolean sameHostAndPort(HttpUrl url) {
        ...
        return url.port() == url2.port() && C9768m.m32341a(url.host(), url2.host());
    }
