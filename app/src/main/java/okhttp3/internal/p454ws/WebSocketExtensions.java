...
public final /* data */ class WebSocketExtensions {
    ...
    public static final class Companion {
        ...
        public final WebSocketExtensions parse(Headers responseHeaders) throws IOException {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                if (C10513u.m37515q(responseHeaders.name(i2), WebSocketExtensions.HEADER_WEB_SOCKET_EXTENSION, true)) {
                    ...
                    while (i3 < value.length()) {
                        ...
                        if (C10513u.m37515q(trimSubstring, "permessage-deflate", true)) {
                            if (z) {
                                z4 = true;
                            }
                            while (i4 < delimiterOffset$default) {
                                ...
                                String m37575o0 = delimiterOffset3 < delimiterOffset2 ? C10514v.m37575o0(Util.trimSubstring(value, delimiterOffset3 + 1, delimiterOffset2), "\"") : null;
                                int i5 = delimiterOffset2 + 1;
                                if (C10513u.m37515q(trimSubstring2, "client_max_window_bits", true)) {
                                    if (num != null) {
                                        z4 = true;
                                    }
                                    if (m37575o0 != null) {
                                        m37503j2 = C10512t.m37503j(m37575o0);
                                        num = m37503j2;
                                    } else {
                                        num = null;
                                    }
                                    ...
                                    if (C10513u.m37515q(trimSubstring2, "client_no_context_takeover", true)) {
                                        if (z2) {
                                            z4 = true;
                                        }
                                        if (m37575o0 != null) {
                                        ...
                                        z2 = true;
                                    } else if (C10513u.m37515q(trimSubstring2, "server_max_window_bits", true)) {
                                        if (num2 != null) {
                                            z4 = true;
                                        }
                                        if (m37575o0 != null) {
                                            m37503j = C10512t.m37503j(m37575o0);
                                            num2 = m37503j;
                                        } else {
                                            num2 = null;
                                        }
                                        ...
                                        if (C10513u.m37515q(trimSubstring2, "server_no_context_takeover", true)) {
                                            if (z3) {
                                                z4 = true;
                                            }
                                            if (m37575o0 != null) {
    ...
    public boolean equals(Object other) {
        ...
        return this.perMessageDeflate == webSocketExtensions.perMessageDeflate && C9768m.m32341a(this.clientMaxWindowBits, webSocketExtensions.clientMaxWindowBits) && this.clientNoContextTakeover == webSocketExtensions.clientNoContextTakeover && C9768m.m32341a(this.serverMaxWindowBits, webSocketExtensions.serverMaxWindowBits) && this.serverNoContextTakeover == webSocketExtensions.serverNoContextTakeover && this.unknownValues == webSocketExtensions.unknownValues;
    }
    ...
    public /* synthetic */ WebSocketExtensions(boolean z, Integer num, boolean z2, Integer num2, boolean z3, boolean z4, int i2, C9756g c9756g) {
