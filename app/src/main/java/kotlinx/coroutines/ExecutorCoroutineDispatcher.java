...
public abstract class ExecutorCoroutineDispatcher extends CoroutineDispatcher implements Closeable {
    ...
    public static final class a extends AbstractCoroutineContextKey<CoroutineDispatcher, ExecutorCoroutineDispatcher> {
        ...
        static final class C11540a extends Lambda implements Function1<CoroutineContext.b, ExecutorCoroutineDispatcher> {

            /* renamed from: f */
            public static final C11540a f41864f = new C11540a();
        ...
        private a() {
            super(CoroutineDispatcher.f41756f, C11540a.f41864f);
        }
