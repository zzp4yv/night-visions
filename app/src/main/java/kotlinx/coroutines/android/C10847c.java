...
public final class C10847c {
    ...
    static {
        ...
        try {
            ...
            m37650a = Result.m37650a(new HandlerContext(m39111a(Looper.getMainLooper(), true), objArr2 == true ? 1 : 0, 2, objArr == true ? 1 : 0));
        } catch (Throwable th) {
            Result.a aVar2 = Result.f40714f;
            m37650a = Result.m37650a(C10535o.m37654a(th));
        }
        f41575a = (HandlerDispatcher) (Result.m37652c(m37650a) ? null : m37650a);
    }

    /* renamed from: a */
    public static final Handler m39111a(Looper looper, boolean z) {
        int i2;
