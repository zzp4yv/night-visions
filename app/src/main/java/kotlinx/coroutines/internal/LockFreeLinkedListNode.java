...
import kotlin.jvm.internal.C9784w;
...
public class LockFreeLinkedListNode {
    ...
    public static abstract class a extends AtomicOp<LockFreeLinkedListNode> {
        ...
        public void mo39286d(LockFreeLinkedListNode lockFreeLinkedListNode, Object obj) {
            ...
            if (lockFreeLinkedListNode2 != null && LockFreeLinkedListNode.f41815f.compareAndSet(lockFreeLinkedListNode, this, lockFreeLinkedListNode2) && z) {
                ...
                C9768m.m32343c(lockFreeLinkedListNode4);
    ...
    */
    ...
    public final LockFreeLinkedListNode m39552B() {
        ...
        do {
            m39557q = m39557q();
            if (m39557q instanceof Removed) {
                return ((Removed) m39557q).f41764a;
            }
            if (m39557q == this) {
                return (LockFreeLinkedListNode) m39557q;
            }
            lockFreeLinkedListNode = (LockFreeLinkedListNode) m39557q;
        } while (!f41815f.compareAndSet(this, m39557q, lockFreeLinkedListNode.m39546C()));
        lockFreeLinkedListNode.m39548n(null);
        return null;
    }
    ...
    public final LockFreeLinkedListNode m39558r() {
        return C10965q.m39545b(m39557q());
    }

    public String toString() {
        return new C9784w(this) { // from class: kotlinx.coroutines.internal.r.c
            @Override // kotlin.reflect.KProperty0
            public Object get() {
                return C11016t0.m39687a(this.receiver);
            }
        } + '@' + C11016t0.m39688b(this);
    }

    /* renamed from: v */
    public final LockFreeLinkedListNode m39559v() {
        LockFreeLinkedListNode m39548n = m39548n(null);
        return m39548n == null ? m39549o((LockFreeLinkedListNode) this._prev) : m39548n;
    }
    ...
    public final void m39561x() {
        ...
        while (true) {
            Object m39557q = lockFreeLinkedListNode.m39557q();
            if (!(m39557q instanceof Removed)) {
                lockFreeLinkedListNode.m39548n(null);
                return;
            }
            lockFreeLinkedListNode = ((Removed) m39557q).f41764a;
        }
    }
