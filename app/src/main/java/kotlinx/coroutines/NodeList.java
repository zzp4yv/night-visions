...
public final class NodeList extends LockFreeLinkedListHead implements Incomplete {
    ...
    public final String m39615G(String str) {
        ...
        sb.append("}[");
        boolean z = true;
        for (LockFreeLinkedListNode lockFreeLinkedListNode = (LockFreeLinkedListNode) m39557q(); !C9768m.m32341a(lockFreeLinkedListNode, this); lockFreeLinkedListNode = lockFreeLinkedListNode.m39558r()) {
    ...
    public String toString() {
        return C11012s0.m39683c() ? m39615G("Active") : super.toString();
    }
}
