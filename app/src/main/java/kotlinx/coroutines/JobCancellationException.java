...
public final class JobCancellationException extends CancellationException implements CopyableThrowable<JobCancellationException> {
    ...
    public boolean equals(Object other) {
        if (other != this) {
            if (other instanceof JobCancellationException) {
                ...
                if (!C9768m.m32341a(jobCancellationException.getMessage(), getMessage()) || !C9768m.m32341a(jobCancellationException.f41557f, this.f41557f) || !C9768m.m32341a(jobCancellationException.getCause(), getCause())) {
                }
            }
            return false;
        }
    ...
    public int hashCode() {
        String message = getMessage();
        C9768m.m32343c(message);
        int hashCode = ((message.hashCode() * 31) + this.f41557f.hashCode()) * 31;
