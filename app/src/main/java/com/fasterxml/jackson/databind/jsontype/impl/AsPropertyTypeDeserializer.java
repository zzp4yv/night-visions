...
public class AsPropertyTypeDeserializer extends AsArrayTypeDeserializer {
    protected final JsonTypeInfo.EnumC5928As _inclusion;

    public AsPropertyTypeDeserializer(JavaType javaType, TypeIdResolver typeIdResolver, String str, boolean z, JavaType javaType2, JsonTypeInfo.EnumC5928As enumC5928As) {
        super(javaType, typeIdResolver, str, z, javaType2);
        this._inclusion = enumC5928As;
    }
