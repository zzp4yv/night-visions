...
public final class SupportFragmentWrapper extends IFragmentWrapper.Stub {
    ...
    @KeepForSdk
    /* renamed from: P */
    public static SupportFragmentWrapper m14711P(Fragment fragment) {
        if (fragment != null) {
    ...
    public final boolean mo14681A0() {
        return this.f18036f.isDetached();
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: D2 */
    public final void mo14682D2(Intent intent, int i2) {
        this.f18036f.startActivityForResult(intent, i2);
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: G */
    public final boolean mo14683G() {
        return this.f18036f.isAdded();
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: P0 */
    public final void mo14684P0(boolean z) {
        this.f18036f.setHasOptionsMenu(z);
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: U */
    public final boolean mo14685U() {
        return this.f18036f.isRemoving();
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: X */
    public final boolean mo14686X() {
        return this.f18036f.isResumed();
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: Z6 */
    public final boolean mo14687Z6() {
        return this.f18036f.isVisible();
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: b */
    public final int mo14688b() {
        return this.f18036f.getId();
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: b2 */
    public final void mo14689b2(boolean z) {
        this.f18036f.setRetainInstance(z);
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: c */
    public final int mo14690c() {
        return this.f18036f.getTargetRequestCode();
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: d */
    public final Bundle mo14691d() {
        return this.f18036f.getArguments();
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: e */
    public final IFragmentWrapper mo14692e() {
        return m14711P(this.f18036f.getParentFragment());
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: f0 */
    public final boolean mo14693f0() {
        return this.f18036f.isHidden();
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: h6 */
    public final void mo14694h6(boolean z) {
        this.f18036f.setUserVisibleHint(z);
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: l */
    public final IObjectWrapper mo14695l() {
        return ObjectWrapper.m14708E0(this.f18036f.getView());
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: l0 */
    public final boolean mo14696l0() {
        return this.f18036f.isInLayout();
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: m */
    public final IObjectWrapper mo14697m() {
        return ObjectWrapper.m14708E0(this.f18036f.getResources());
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: q */
    public final IFragmentWrapper mo14698q() {
        return m14711P(this.f18036f.getTargetFragment());
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: r1 */
    public final void mo14699r1(boolean z) {
        this.f18036f.setMenuVisibility(z);
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: s */
    public final IObjectWrapper mo14700s() {
        return ObjectWrapper.m14708E0(this.f18036f.getActivity());
    }
    ...
    public final void mo14701s0(IObjectWrapper iObjectWrapper) {
        ...
        Fragment fragment = this.f18036f;
    ...
    public final void mo14704w2(Intent intent) {
        this.f18036f.startActivity(intent);
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: x */
    public final boolean mo14705x() {
        return this.f18036f.getRetainInstance();
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    /* renamed from: y */
    public final boolean mo14706y() {
        return this.f18036f.getUserVisibleHint();
    }
}
