...
final class C6286a extends AbstractC6290e<Status> {
    C6286a(GoogleApiClient googleApiClient) {
    ...
    protected final /* synthetic */ void mo13719s(zzg zzgVar) throws RemoteException {
        zzg zzgVar2 = zzgVar;
        ((zzu) zzgVar2.getService()).mo13741i3(new BinderC6287b(this), zzgVar2.m13727j());
    }
}
