...
final class C7584y extends zzx.AbstractRunnableC7600a {

    /* renamed from: j */
    private final /* synthetic */ Activity f27935j;

    /* renamed from: k */
    private final /* synthetic */ zzx.C7602c f27936k;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    C7584y(zzx.C7602c c7602c, Activity activity) {
        super(zzx.this);
        this.f27936k = c7602c;
    ...
    final void mo20969a() throws RemoteException {
        ...
        zzmVar.onActivityDestroyed(ObjectWrapper.m14708E0(this.f27935j), this.f28413g);
    }
}
