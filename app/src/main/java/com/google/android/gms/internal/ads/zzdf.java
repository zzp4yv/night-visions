...
public class zzdf extends zzdd {
    ...
    private static zzee m19310f(zzdy zzdyVar, MotionEvent motionEvent, DisplayMetrics displayMetrics) throws zzdv {
        Method m19906p = zzdyVar.m19906p("3jRp5GOI+HfffIZaNgs5urp4INMy6m1jZanprlp8fEbfjaITI/GTtSmO29P018Ft", "3ps9rI142V56fUZ22VD6Aav/U6wPd6aBlBvFChUyHGs=");
        if (m19906p == null || motionEvent == null) {
            throw new zzdv();
        }
        try {
            return new zzee((String) m19906p.invoke(null, motionEvent, displayMetrics));
    ...
    /* renamed from: i */
    protected static void m19312i(List<Callable<Void>> list) {
        ExecutorService m19908r;
        if (zzdd.f25486f == null || (m19908r = zzdd.f25486f.m19908r()) == null || list.isEmpty()) {
            return;
        }
        try {
            m19908r.invokeAll(list, ((Long) zzyt.m20848e().m16421c(zzacu.f21817k2)).longValue(), TimeUnit.MILLISECONDS);
    ...
    protected final long mo19223a(StackTraceElement[] stackTraceElementArr) throws zzdv {
        Method m19906p = zzdd.f25486f.m19906p("/88MDl9rX1PoHRuLz6sEkbzq0+/JaeA7z8TdQwdu+XCq1g0SXeRpE8fX29WzS14O", "IIJxA/RzEPbEgRJQH0LQ8KVHKqG3NyhvdpUemJxyiMg=");
        if (m19906p == null || stackTraceElementArr == null) {
            throw new zzdv();
        }
        try {
            return new zzdw((String) m19906p.invoke(null, stackTraceElementArr)).f26002b.longValue();
        } catch (IllegalAccessException | InvocationTargetException e2) {
            throw new zzdv(e2);
        }
    }
    ...
    @Override // com.google.android.gms.internal.ads.zzdd
    /* renamed from: b */
    protected zzbp.zza.C11431zza mo19224b(Context context, View view, Activity activity) {
        List list;
        Long l;
        MotionEvent motionEvent;
        zzbp.zza.C11431zza m18013k0 = zzbp.zza.m18013k0();
        if (!TextUtils.isEmpty(this.f25523E)) {
            m18013k0.m18054B0(this.f25523E);
        }
        zzdy m19313j = m19313j(context, this.f25522D);
        if (m19313j.m19902b()) {
            try {
                zzee m19310f = m19310f(m19313j, this.f25487g, this.f25505y);
                Long l2 = m19310f.f26027b;
                if (l2 != null) {
                    m18013k0.m18063J(l2.longValue());
                }
                Long l3 = m19310f.f26028c;
                if (l3 != null) {
                    m18013k0.m18064K(l3.longValue());
                }
                Long l4 = m19310f.f26029d;
                if (l4 != null) {
                    m18013k0.m18065L(l4.longValue());
                }
                if (this.f25504x) {
                    Long l5 = m19310f.f26030e;
                    if (l5 != null) {
                        m18013k0.m18078a0(l5.longValue());
                    }
                    Long l6 = m19310f.f26031f;
                    if (l6 != null) {
                        m18013k0.m18079b0(l6.longValue());
                    }
                }
            } catch (zzdv unused) {
            }
            zzbp.zza.zze.C11432zza m18108A = zzbp.zza.zze.m18108A();
            if (this.f25489i > 0 && zzef.m19920d(this.f25505y)) {
                m18108A.m18158I(zzef.m19918b(this.f25496p, this.f25505y));
                m18108A.m18159J(zzef.m19918b(this.f25501u - this.f25499s, this.f25505y)).m18160K(zzef.m19918b(this.f25502v - this.f25500t, this.f25505y)).m18163N(zzef.m19918b(this.f25499s, this.f25505y)).m18164O(zzef.m19918b(this.f25500t, this.f25505y));
                if (this.f25504x && (motionEvent = this.f25487g) != null) {
                    long m19918b = zzef.m19918b(((this.f25499s - this.f25501u) + motionEvent.getRawX()) - this.f25487g.getX(), this.f25505y);
                    if (m19918b != 0) {
                        m18108A.m18161L(m19918b);
                    }
                    long m19918b2 = zzef.m19918b(((this.f25500t - this.f25502v) + this.f25487g.getRawY()) - this.f25487g.getY(), this.f25505y);
                    if (m19918b2 != 0) {
                        m18108A.m18162M(m19918b2);
                    }
                }
            }
            try {
                zzee mo19226e = mo19226e(this.f25487g);
                Long l7 = mo19226e.f26027b;
                if (l7 != null) {
                    m18108A.m18168v(l7.longValue());
                }
                Long l8 = mo19226e.f26028c;
                if (l8 != null) {
                    m18108A.m18169w(l8.longValue());
                }
                m18108A.m18154E(mo19226e.f26029d.longValue());
                if (this.f25504x) {
                    Long l9 = mo19226e.f26031f;
                    if (l9 != null) {
                        m18108A.m18150A(l9.longValue());
                    }
                    Long l10 = mo19226e.f26030e;
                    if (l10 != null) {
                        m18108A.m18152C(l10.longValue());
                    }
                    Long l11 = mo19226e.f26032g;
                    if (l11 != null) {
                        m18108A.m18165P(l11.longValue() != 0 ? zzbz.ENUM_TRUE : zzbz.ENUM_FALSE);
                    }
                    if (this.f25490j > 0) {
                        ...
                        Double.isNaN(d4);
                        Double.isNaN(d5);
                        m18108A.m18153D(Math.round(d4 / d5));
                    }
                    Long l12 = mo19226e.f26035j;
                    if (l12 != null) {
                        m18108A.m18156G(l12.longValue());
                    }
                    Long l13 = mo19226e.f26036k;
                    if (l13 != null) {
                        m18108A.m18155F(l13.longValue());
                    }
                    Long l14 = mo19226e.f26037l;
                    if (l14 != null) {
                        m18108A.m18166Q(l14.longValue() != 0 ? zzbz.ENUM_TRUE : zzbz.ENUM_FALSE);
                    }
                }
            } catch (zzdv unused2) {
            }
            ...
            m18013k0.m18096u0((zzbp.zza.zze) ((zzdob) m18108A.mo19736p0()));
            long j3 = this.f25489i;
            if (j3 > 0) {
                m18013k0.m18082f0(j3);
            }
            long j4 = this.f25490j;
            if (j4 > 0) {
                m18013k0.m18081d0(j4);
            }
            long j5 = this.f25491k;
            if (j5 > 0) {
                m18013k0.m18080c0(j5);
            }
            long j6 = this.f25492l;
            if (j6 > 0) {
                m18013k0.m18083g0(j6);
            }
            try {
                ...
                if (size > 0) {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        zzee m19310f2 = m19310f(zzdd.f25486f, this.f25488h.get(i2), this.f25505y);
                        m18013k0.m18098v0((zzbp.zza.zze) ((zzdob) zzbp.zza.zze.m18108A().m18168v(m19310f2.f26027b.longValue()).m18169w(m19310f2.f26028c.longValue()).mo19736p0()));
                    }
                }
            } catch (zzdv unused3) {
                m18013k0.m18060G();
            ...
            if (m19313j.m19908r() != null) {
                int m19907q = m19313j.m19907q();
                arrayList.add(new zzet(m19313j, m18013k0));
                arrayList.add(new zzex(m19313j, "lQFXQNWHSdYD6r5tE84uy22hnfx5d1uQHcaULCOPbM14F5cpADjDJSLZMM39MwXu", "pJdDeMB2kv4XBHX5K3sZ2yiaFa+GF7/AJrrVARYf41I=", m18013k0, m19907q, 1));
                arrayList.add(new zzer(m19313j, "SJ3SRTdt7T2FQX1UH4DWlnlLfmao1u+KeMI8XtxEgmSHdfgiJRyy0Txw8FmQ+pQw", "KF7kIGwoAULxxzCbY3v7c6qTHz0AzEhtAn+fEEmtiVY=", m18013k0, f25520C, m19907q, 25));
                arrayList.add(new zzeq(m19313j, "eeHcOeF0utKeJ3TdD/Pwtm6cWd04Ztm9wYmjRiH4t4Gg4JcxT94Ww8qOUzEwK/Zq", "1W0/YCPJzEmk/HgpAgOnsO7nBKJT5v7+JoPGhWP2ZMU=", m18013k0, m19907q, 44));
                arrayList.add(new zzew(m19313j, "Y/1pb58VeX4F8K6fayOs4meS93jwIQ+AMpk0KVFaduEwXDgWis9Z812p7+pIfyJn", "SdFaXE08C//Nhl+gRjvJmRjmg4SkhkRbwfGg/uU8x2s=", m18013k0, m19907q, 12));
                arrayList.add(new zzey(m19313j, "gx/1BDivw1L00TdbKz0RVSB9i6BArwMvYzyXN9/QhtElzG15Zr/lNxD9PAeoKiHl", "kTfa3GHpchXDI5O/v3QdvSJh/jOvH3Ukv7M6fmtnsGg=", m18013k0, m19907q, 3));
                arrayList.add(new zzeu(m19313j, "sy4DcIHS9wxJsfwoEmK8Dm6Gi31a3y/93mj8TIbrG5gLa7E0wVZAyh/XGhFGnL+Q", "3noVyuO3zFOuhvGfjg9nufIidaw0HmgQ5EVdw6MbLqs=", m18013k0, m19907q, 22));
                arrayList.add(new zzep(m19313j, "SgMhksOnpMJMBH1JH74BErFMAiPE78L9kUpiye6ezUkIKoc+RVuDLvEf36QK5tpM", "j+Yj7UMoEzr9M6nnqL4N+TgP7ihZaPMbtnYW3NPxsNU=", m18013k0, m19907q, 5));
                arrayList.add(new zzfg(m19313j, "B9q/kZ3M4smaULlSVckwEJdUNHNhTESXBf44c8ZRnHeQQYAcBESnaqAhjIPahrI0", "aShZq0/KR6YDgcaEp7oqLU/eOeJ/Ib2TFfcDX4UbQAw=", m18013k0, m19907q, 48));
                arrayList.add(new zzel(m19313j, "r05ido8PpVZ2h2V1HWb8y18UjWvZxnyZOvYK4Y06JVkYZsi7FS/S9aZJacgWNWb+", "RDFKlEPOT0aQT6ARmaMKbVy+V0L7x+JIeY4JSh39pzY=", m18013k0, m19907q, 49));
                arrayList.add(new zzfd(m19313j, "e3NEybi6UG3v8IfP2IiRsp6KKM0H99WDhy4AYfUmNolCq+mgpr0V0zn7xdgcLXPM", "u9BpIJMOtL/2Nsb77WSog28jmBm02bMBlDODmG/3YEo=", m18013k0, m19907q, 51));
                arrayList.add(new zzfc(m19313j, "/88MDl9rX1PoHRuLz6sEkbzq0+/JaeA7z8TdQwdu+XCq1g0SXeRpE8fX29WzS14O", "IIJxA/RzEPbEgRJQH0LQ8KVHKqG3NyhvdpUemJxyiMg=", m18013k0, m19907q, 45, new Throwable().getStackTrace()));
                arrayList.add(new zzfh(m19313j, "DRYWi0TWx0xeQUvY98UNqkz37+DffrKoPBm+2dnlFUG6mCEAnCrfVx/sGMEehzhv", "Kdm/VBMF7iBcZ9grhMfx9Tj4MMt8RNRYpD/uKt2ZdeY=", m18013k0, m19907q, 57, view));
                arrayList.add(new zzfb(m19313j, "1OoeMBy/0f4cuo3Q6fO79anCMG2ySlElR0298tBh7pCa++J4MQSzo8NUX4DLdHow", "9bH7YEZYe5itvs31c1gcj+rhSSdPNkSIQfDNYXo9ahs=", m18013k0, m19907q, 61));
                if (((Boolean) zzyt.m20848e().m16421c(zzacu.f21823l2)).booleanValue()) {
                    arrayList.add(new zzek(m19313j, "Rd5vBa3cRt13XnZUPrTszYMRTqEgpzuKs4niQNpf2R+gTE/2OPB9o8u+o5NCRvjI", "FfddiHmPb383DV6rreW8JKkRsedppg8iNKEfTaDysv4=", m18013k0, m19907q, 62, view, activity));
                }
                if (((Boolean) zzyt.m20848e().m16421c(zzacu.f21835n2)).booleanValue()) {
                    arrayList.add(new zzfe(m19313j, "GbK5uSm/ozfwgv6o3qbqx6fDKHstTdGTpmTKU4TJ3rNL7mCxZBP5PDEDf/9caqZb", "Bl3RSPeFXX48+A41tWFMGRj6+1eT4NHtkwATNUdtNkM=", m18013k0, m19907q, 53, this.f25526H));
                }
            }
            list = arrayList;
        } else {
            m18013k0.m18067N(zzbp.zza.zzd.PSN_INITIALIZATION_FAIL.mo17879i());
            list = Arrays.asList(new zzet(m19313j, m18013k0));
        }
        m19312i(list);
        return m18013k0;
    }
    ...
    @Override // com.google.android.gms.internal.ads.zzdd
    /* renamed from: c */
    protected final zzbp.zza.C11431zza mo19225c(Context context, zzbk.zza zzaVar) {
        zzbp.zza.C11431zza m18013k0 = zzbp.zza.m18013k0();
        if (!TextUtils.isEmpty(this.f25523E)) {
            m18013k0.m18054B0(this.f25523E);
        }
        mo19248h(m19313j(context, this.f25522D), context, m18013k0, zzaVar);
        if (zzaVar != null && zzaVar.m17804A()) {
            if (((Boolean) zzyt.m20848e().m16421c(zzacu.f21841o2)).booleanValue() && !zzef.m19922f(zzaVar.m17805B().m17814y())) {
                m18013k0.m18075V((zzbp.zzf) ((zzdob) zzbp.zzf.m18212z().m18213u(zzaVar.m17805B().m17814y()).mo19736p0()));
            }
        }
        return m18013k0;
    }
    ...
    protected final zzee mo19226e(MotionEvent motionEvent) throws zzdv {
        Method m19906p = zzdd.f25486f.m19906p("mfDIsnw62VUq5CrwQygwwDHX4oFb9NZomMa1Qv0blGOGPAtzm7d2+whMgYfVEkXw", "kd3av/xIh4WVmhBCVqo9sHJVJ1Nfp9EEBESbqmCB4V8=");
        if (m19906p == null || motionEvent == null) {
            throw new zzdv();
        }
        try {
            return new zzee((String) m19906p.invoke(null, motionEvent, this.f25505y));
        } catch (IllegalAccessException | InvocationTargetException e2) {
            throw new zzdv(e2);
        }
    }
    ...
    /* renamed from: h */
    protected void mo19248h(zzdy zzdyVar, Context context, zzbp.zza.C11431zza c11431zza, zzbk.zza zzaVar) {
        if (zzdyVar.m19908r() == null) {
            return;
        }
        m19312i(mo19249k(zzdyVar, context, c11431zza, zzaVar));
    }

    /* renamed from: k */
    protected List<Callable<Void>> mo19249k(zzdy zzdyVar, Context context, zzbp.zza.C11431zza c11431zza, zzbk.zza zzaVar) {
        int m19907q = zzdyVar.m19907q();
        ArrayList arrayList = new ArrayList();
        if (!zzdyVar.m19902b()) {
            c11431zza.m18067N(zzbp.zza.zzd.PSN_INITIALIZATION_FAIL.mo17879i());
            return arrayList;
        }
        arrayList.add(new zzen(zzdyVar, "pORZNbNq0Oj61ZjvW9kWzatiK7LMxOR6JjGIN24dRVcLieCRVYuov8581WrmSeOY", "BYT/lgG9eBlnAgDZzPD0oHgzdaaxxy72moL0pisX7NM=", c11431zza, m19907q, 27, context, zzaVar));
        arrayList.add(new zzer(zzdyVar, "SJ3SRTdt7T2FQX1UH4DWlnlLfmao1u+KeMI8XtxEgmSHdfgiJRyy0Txw8FmQ+pQw", "KF7kIGwoAULxxzCbY3v7c6qTHz0AzEhtAn+fEEmtiVY=", c11431zza, f25520C, m19907q, 25));
        arrayList.add(new zzex(zzdyVar, "lQFXQNWHSdYD6r5tE84uy22hnfx5d1uQHcaULCOPbM14F5cpADjDJSLZMM39MwXu", "pJdDeMB2kv4XBHX5K3sZ2yiaFa+GF7/AJrrVARYf41I=", c11431zza, m19907q, 1));
        arrayList.add(new zzfa(zzdyVar, "0Kgq4AlB9gd85m/CalTu9ABNPLlfchiAkej4yj7Tj8IATJXyqWAQPMLSCSbNBf/m", "7VR2YqvFgyvOhGA7139KYJuSHHdzdCxudZ7JSzwex/E=", c11431zza, m19907q, 31));
        arrayList.add(new zzff(zzdyVar, "Tx+r89A46YvA23pzmXogrUOA3X/vGVWSwDDb1CKb3SB+k9Zvmo8EcgSe2zWDveRy", "tJgqVBYK8iACgXDpES6chgsdiLTk4pCmM15TE0z3kgM=", c11431zza, m19907q, 33));
        arrayList.add(new zzem(zzdyVar, "RLH60+LqkTN+fFoMkyZr3rdaQt8CbwdFGeiAHk8G/Y1GpQIgUmMEvr7Qzmd4S0T8", "syWhPUhrPj9a+Sk0yzwWVrNh+MlfsynriPZ0XF+UPwU=", c11431zza, m19907q, 29, context));
        arrayList.add(new zzep(zzdyVar, "SgMhksOnpMJMBH1JH74BErFMAiPE78L9kUpiye6ezUkIKoc+RVuDLvEf36QK5tpM", "j+Yj7UMoEzr9M6nnqL4N+TgP7ihZaPMbtnYW3NPxsNU=", c11431zza, m19907q, 5));
        arrayList.add(new zzew(zzdyVar, "Y/1pb58VeX4F8K6fayOs4meS93jwIQ+AMpk0KVFaduEwXDgWis9Z812p7+pIfyJn", "SdFaXE08C//Nhl+gRjvJmRjmg4SkhkRbwfGg/uU8x2s=", c11431zza, m19907q, 12));
        arrayList.add(new zzey(zzdyVar, "gx/1BDivw1L00TdbKz0RVSB9i6BArwMvYzyXN9/QhtElzG15Zr/lNxD9PAeoKiHl", "kTfa3GHpchXDI5O/v3QdvSJh/jOvH3Ukv7M6fmtnsGg=", c11431zza, m19907q, 3));
        arrayList.add(new zzeq(zzdyVar, "eeHcOeF0utKeJ3TdD/Pwtm6cWd04Ztm9wYmjRiH4t4Gg4JcxT94Ww8qOUzEwK/Zq", "1W0/YCPJzEmk/HgpAgOnsO7nBKJT5v7+JoPGhWP2ZMU=", c11431zza, m19907q, 44));
        arrayList.add(new zzeu(zzdyVar, "sy4DcIHS9wxJsfwoEmK8Dm6Gi31a3y/93mj8TIbrG5gLa7E0wVZAyh/XGhFGnL+Q", "3noVyuO3zFOuhvGfjg9nufIidaw0HmgQ5EVdw6MbLqs=", c11431zza, m19907q, 22));
        arrayList.add(new zzfg(zzdyVar, "B9q/kZ3M4smaULlSVckwEJdUNHNhTESXBf44c8ZRnHeQQYAcBESnaqAhjIPahrI0", "aShZq0/KR6YDgcaEp7oqLU/eOeJ/Ib2TFfcDX4UbQAw=", c11431zza, m19907q, 48));
        arrayList.add(new zzel(zzdyVar, "r05ido8PpVZ2h2V1HWb8y18UjWvZxnyZOvYK4Y06JVkYZsi7FS/S9aZJacgWNWb+", "RDFKlEPOT0aQT6ARmaMKbVy+V0L7x+JIeY4JSh39pzY=", c11431zza, m19907q, 49));
        arrayList.add(new zzfd(zzdyVar, "e3NEybi6UG3v8IfP2IiRsp6KKM0H99WDhy4AYfUmNolCq+mgpr0V0zn7xdgcLXPM", "u9BpIJMOtL/2Nsb77WSog28jmBm02bMBlDODmG/3YEo=", c11431zza, m19907q, 51));
        arrayList.add(new zzfb(zzdyVar, "1OoeMBy/0f4cuo3Q6fO79anCMG2ySlElR0298tBh7pCa++J4MQSzo8NUX4DLdHow", "9bH7YEZYe5itvs31c1gcj+rhSSdPNkSIQfDNYXo9ahs=", c11431zza, m19907q, 61));
        if (((Boolean) zzyt.m20848e().m16421c(zzacu.f21895x2)).booleanValue()) {
            arrayList.add(new zzev(zzdyVar, "2OUUc7NT0WkEjmK9+FJMealFwLTaZNBfYG9mkUVQmhidcpLE5upPJKg2uqM0WUBe", "YNpg6iogaN//xvhlb+wHna+ciVxu4p8AB/spEu+x8aQ=", c11431zza, m19907q, 11));
        }
        if (((Boolean) zzyt.m20848e().m16421c(zzacu.f21889w2)).booleanValue()) {
            arrayList.add(new zzez(zzdyVar, "WPHSlfekhaYlGJ3yiaIbiBY4HTx7YM9tPghNjV2alPYI+KXTjj+VnW7A1O7Euzu8", "uhLcqjqmx4nAmM3qRNIgYeeALxilkZ+lc3aGgO+rkRY=", c11431zza, m19907q, 73));
        }
        return arrayList;
    }
