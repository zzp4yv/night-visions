...
public final class zzex extends AbstractC7670f7 {
    ...
    public zzex(zzkc zzkcVar) {
        super(zzkcVar);
        this.f29228d = Build.VERSION.SDK_INT < 19 ? new C7751o7() : null;
    }
    ...
    public final boolean m23154z() {
        ...
        m22778t();
        try {
            networkInfo = ((ConnectivityManager) mo22834f().getSystemService("connectivity")).getActiveNetworkInfo();
