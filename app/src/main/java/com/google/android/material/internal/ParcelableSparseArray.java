...
public class ParcelableSparseArray extends SparseArray<Parcelable> implements Parcelable {
    public static final Parcelable.Creator<ParcelableSparseArray> CREATOR = new C7989a();

    /* renamed from: com.google.android.material.internal.ParcelableSparseArray$a */
    static class C7989a implements Parcelable.ClassLoaderCreator<ParcelableSparseArray> {
        C7989a() {
        }
