...
public final class C8615i {
    ...
    /* renamed from: c */
    public static String m27353c(String str, C8617k c8617k) {
        if (str.length() != c8617k.m27372a()) {
            throw new IllegalArgumentException("The number of codewords does not match the selected symbol");
        }
        StringBuilder sb = new StringBuilder(c8617k.m27372a() + c8617k.m27373c());
        sb.append(str);
        int mo27317f = c8617k.mo27317f();
        if (mo27317f == 1) {
            sb.append(m27351a(str, c8617k.m27373c()));
        } else {
            sb.setLength(sb.capacity());
            int[] iArr = new int[mo27317f];
            int[] iArr2 = new int[mo27317f];
            int[] iArr3 = new int[mo27317f];
            int i2 = 0;
            while (i2 < mo27317f) {
                int i3 = i2 + 1;
                iArr[i2] = c8617k.mo27316b(i3);
                iArr2[i2] = c8617k.m27374d(i3);
                iArr3[i2] = 0;
                if (i2 > 0) {
            ...
            for (int i4 = 0; i4 < mo27317f; i4++) {
                StringBuilder sb2 = new StringBuilder(iArr[i4]);
                for (int i5 = i4; i5 < c8617k.m27372a(); i5 += mo27317f) {
                    sb2.append(str.charAt(i5));
                }
                String m27351a = m27351a(sb2.toString(), iArr2[i4]);
                int i6 = i4;
                int i7 = 0;
                while (i6 < iArr2[i4] * mo27317f) {
                    sb.setCharAt(c8617k.m27372a() + i6, m27351a.charAt(i7));
                    i6 += mo27317f;
                    i7++;
                }
            }
