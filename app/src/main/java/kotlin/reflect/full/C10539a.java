...
public final class C10539a {
    ...
    public static final <T> Collection<KProperty1<T, ?>> m37662a(KClass<T> kClass) {
        ...
        Collection<KCallableImpl<?>> m32592g = ((KClassImpl) kClass).m32580Q().invoke().m32592g();
    ...
    public static final <T> KFunction<T> m37663b(KClass<T> kClass) {
        ...
        while (true) {
            ...
            C9768m.m32344d(kFunction, "null cannot be cast to non-null type kotlin.reflect.jvm.internal.KFunctionImpl");
            InterfaceC10705y mo37304F = ((KFunctionImpl) kFunction).mo37304F();
            C9768m.m32344d(mo37304F, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ConstructorDescriptor");
            if (((InterfaceC10573l) mo37304F).mo37713B()) {
                break;
            }
        }
        return (KFunction) t;
