...
public final class CompletedContinuation implements Continuation<Object> {
    ...
    /* renamed from: f */
    public static final CompletedContinuation f41542f = new CompletedContinuation();
