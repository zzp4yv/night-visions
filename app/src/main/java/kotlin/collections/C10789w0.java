...
public class C10789w0 extends C10787v0 {
    /* renamed from: d */
    ...
    public static <T> HashSet<T> m38918e(T... tArr) {
        ...
        m38793e = C10775p0.m38793e(tArr.length);
        return (HashSet) C10770n.m38738R(tArr, new HashSet(m38793e));
    }
    ...
    public static <T> LinkedHashSet<T> m38919f(T... tArr) {
        ...
        C9768m.m32346f(tArr, "elements");
        m38793e = C10775p0.m38793e(tArr.length);
        return (LinkedHashSet) C10770n.m38738R(tArr, new LinkedHashSet(m38793e));
    }
    ...
    public static <T> Set<T> m38920g(T... tArr) {
        ...
        C9768m.m32346f(tArr, "elements");
        m38793e = C10775p0.m38793e(tArr.length);
        return (Set) C10770n.m38738R(tArr, new LinkedHashSet(m38793e));
    }
    ...
    public static final <T> Set<T> m38921h(Set<? extends T> set) {
        ...
        m38916c = C10787v0.m38916c(set.iterator().next());
        return m38916c;
    }
    ...
    public static <T> Set<T> m38922i(T... tArr) {
        ...
        C9768m.m32346f(tArr, "elements");
        if (tArr.length > 0) {
            m38758l0 = C10770n.m38758l0(tArr);
            return m38758l0;
        }
        m38917d = m38917d();
        return m38917d;
