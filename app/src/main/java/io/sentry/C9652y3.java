...
public final class C9652y3 implements InterfaceC9646x3 {

    /* renamed from: a */
    private final InterfaceC9627v3 f37022a;

    public C9652y3(InterfaceC9627v3 interfaceC9627v3) {
        this.f37022a = (InterfaceC9627v3) C9613q.m31802c(interfaceC9627v3, "SendFireAndForgetDirPath is required");
    }
    ...
    public InterfaceC9594u3 mo31941b(InterfaceC9625v1 interfaceC9625v1, C9647x4 c9647x4) {
        ...
        String mo30388a = this.f37022a.mo30388a();
        if (mo30388a != null && mo31942c(mo30388a, c9647x4.getLogger())) {
            return mo31940a(new C9437i1(interfaceC9625v1, c9647x4.getSerializer(), c9647x4.getLogger(), c9647x4.getFlushTimeoutMillis()), mo30388a, c9647x4.getLogger());
        }
